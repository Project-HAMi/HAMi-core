...
enum hostpid_discovery_path hostpid_discovery_path_select(
    int broker_enabled, int broker_succeeded) {
    if (broker_succeeded) {
        return HOSTPID_DISCOVERY_BROKER;
    }
    return broker_enabled ? HOSTPID_DISCOVERY_NODE_WIDE
