...
void* __dlsym_hook_section(void* handle, const char* symbol) {
    ...
    //Context
    DLSYM_HOOK_FUNC_REPLACE(cuCtxGetDevice);
    DLSYM_HOOK_FUNC_REPLACE(cuCtxCreate_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuDevicePrimaryCtxGetState);
    DLSYM_HOOK_FUNC_REPLACE(cuDevicePrimaryCtxRetain);
    DLSYM_HOOK_FUNC_REPLACE(cuDevicePrimaryCtxSetFlags_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuDevicePrimaryCtxRelease_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuDriverGetVersion);
    DLSYM_HOOK_FUNC_REPLACE(cuDeviceGetTexture1DLinearMaxWidth);
    DLSYM_HOOK_FUNC_REPLACE(cuDeviceSetMemPool);
    DLSYM_HOOK_FUNC_REPLACE(cuFlushGPUDirectRDMAWrites);

    DLSYM_HOOK_FUNC_REPLACE(cuCtxDestroy_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuCtxGetApiVersion);
    DLSYM_HOOK_FUNC_REPLACE(cuCtxGetCacheConfig);
    DLSYM_HOOK_FUNC_REPLACE(cuCtxGetCurrent);
    DLSYM_HOOK_FUNC_REPLACE(cuCtxGetDevice);
    DLSYM_HOOK_FUNC_REPLACE(cuCtxGetFlags);
    DLSYM_HOOK_FUNC_REPLACE(cuCtxGetLimit);
    DLSYM_HOOK_FUNC_REPLACE(cuCtxGetSharedMemConfig);
    DLSYM_HOOK_FUNC_REPLACE(cuCtxGetStreamPriorityRange);
    DLSYM_HOOK_FUNC_REPLACE(cuCtxPopCurrent_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuCtxPushCurrent_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuCtxSetCacheConfig);
    DLSYM_HOOK_FUNC_REPLACE(cuCtxSetCurrent);
    DLSYM_HOOK_FUNC_REPLACE(cuCtxSetLimit);
    DLSYM_HOOK_FUNC_REPLACE(cuCtxSetSharedMemConfig);
    DLSYM_HOOK_FUNC_REPLACE(cuCtxSynchronize);
    //DLSYM_HOOK_FUNC_REPLACE(cuCtxEnablePeerAccess);
    //DLSYM_HOOK_FUNC(cuGetExportTable);


    DLSYM_HOOK_FUNC_REPLACE(cuInit);
    DLSYM_HOOK_FUNC_REPLACE(cuArray3DCreate_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuArrayCreate_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuArrayDestroy);
    DLSYM_HOOK_FUNC_REPLACE(cuMemAlloc_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemAllocHost_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemAllocManaged);
    DLSYM_HOOK_FUNC_REPLACE(cuMemAllocPitch_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemFree_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemFreeHost);
    DLSYM_HOOK_FUNC_REPLACE(cuMemHostAlloc);
    DLSYM_HOOK_FUNC_REPLACE(cuMemHostRegister_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemHostUnregister);
    DLSYM_HOOK_FUNC_REPLACE(cuMipmappedArrayCreate);
    DLSYM_HOOK_FUNC_REPLACE(cuMipmappedArrayDestroy);
    DLSYM_HOOK_FUNC_REPLACE(cuStreamCreate);
    DLSYM_HOOK_FUNC_REPLACE(cuStreamDestroy_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuStreamSynchronize);
    DLSYM_HOOK_FUNC_REPLACE(cuDeviceGetAttribute);
    DLSYM_HOOK_FUNC_REPLACE(cuDeviceGetCount);
    DLSYM_HOOK_FUNC_REPLACE(cuDeviceGet);
    DLSYM_HOOK_FUNC_REPLACE(cuDeviceGetName);
    DLSYM_HOOK_FUNC_REPLACE(cuDeviceCanAccessPeer);
    DLSYM_HOOK_FUNC_REPLACE(cuDeviceGetP2PAttribute);
    DLSYM_HOOK_FUNC_REPLACE(cuDeviceGetByPCIBusId);
    DLSYM_HOOK_FUNC_REPLACE(cuDeviceGetPCIBusId);
    DLSYM_HOOK_FUNC_REPLACE(cuDeviceGetDefaultMemPool);
    DLSYM_HOOK_FUNC_REPLACE(cuDeviceGetLuid);
    DLSYM_HOOK_FUNC_REPLACE(cuDeviceGetUuid);
    DLSYM_HOOK_FUNC_REPLACE(cuDeviceGetMemPool);
    DLSYM_HOOK_FUNC_REPLACE(cuDeviceTotalMem_v2);

    DLSYM_HOOK_FUNC_REPLACE(cuPointerGetAttributes);
    DLSYM_HOOK_FUNC_REPLACE(cuPointerGetAttribute);
    DLSYM_HOOK_FUNC_REPLACE(cuPointerSetAttribute);
    DLSYM_HOOK_FUNC_REPLACE(cuFuncSetCacheConfig);
    DLSYM_HOOK_FUNC_REPLACE(cuFuncSetSharedMemConfig);
    DLSYM_HOOK_FUNC_REPLACE(cuFuncGetAttribute);
    DLSYM_HOOK_FUNC_REPLACE(cuFuncSetAttribute);
    DLSYM_HOOK_FUNC_REPLACE(cuLaunchKernel);
    DLSYM_HOOK_FUNC_REPLACE(cuLaunchCooperativeKernel);
    DLSYM_HOOK_FUNC_REPLACE(cuIpcOpenMemHandle_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuIpcGetMemHandle);
    DLSYM_HOOK_FUNC_REPLACE(cuIpcCloseMemHandle);
    DLSYM_HOOK_FUNC_REPLACE(cuMemGetAddressRange_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemcpy);
    DLSYM_HOOK_FUNC_REPLACE(cuMemcpyPeer);
    DLSYM_HOOK_FUNC_REPLACE(cuMemcpyPeerAsync);
    DLSYM_HOOK_FUNC_REPLACE(cuMemcpyAsync);
    DLSYM_HOOK_FUNC_REPLACE(cuMemcpyAtoD_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemcpyDtoA_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemcpyDtoDAsync_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemcpyDtoD_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemcpyDtoDAsync_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemcpyDtoH_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemcpyDtoHAsync_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemcpyHtoD_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemcpyHtoDAsync_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemsetD16_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemsetD16Async);
    DLSYM_HOOK_FUNC_REPLACE(cuMemsetD2D16_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemsetD2D16Async);
    DLSYM_HOOK_FUNC_REPLACE(cuMemsetD2D32_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemsetD2D32Async);
    DLSYM_HOOK_FUNC_REPLACE(cuMemsetD2D8_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemsetD2D8Async);
    DLSYM_HOOK_FUNC_REPLACE(cuMemsetD32_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemsetD32Async);
    DLSYM_HOOK_FUNC_REPLACE(cuMemsetD8_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemsetD8Async);
    DLSYM_HOOK_FUNC_REPLACE(cuMemAdvise);

    DLSYM_HOOK_FUNC_REPLACE(cuEventCreate);
    DLSYM_HOOK_FUNC_REPLACE(cuEventDestroy_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuModuleLoad);
    DLSYM_HOOK_FUNC_REPLACE(cuModuleLoadData);
    DLSYM_HOOK_FUNC_REPLACE(cuModuleLoadDataEx);
    DLSYM_HOOK_FUNC_REPLACE(cuModuleLoadFatBinary);
    DLSYM_HOOK_FUNC_REPLACE(cuModuleGetFunction);
    DLSYM_HOOK_FUNC_REPLACE(cuModuleUnload);
    DLSYM_HOOK_FUNC_REPLACE(cuModuleGetGlobal_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuModuleGetTexRef);
    DLSYM_HOOK_FUNC_REPLACE(cuModuleGetSurfRef);
    DLSYM_HOOK_FUNC_REPLACE(cuLinkAddData_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuLinkCreate_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuLinkAddFile_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuLinkComplete);
    DLSYM_HOOK_FUNC_REPLACE(cuLinkDestroy);

    DLSYM_HOOK_FUNC_REPLACE(cuMemAddressReserve);
    DLSYM_HOOK_FUNC_REPLACE(cuMemCreate);
    DLSYM_HOOK_FUNC_REPLACE(cuMemMap);
    DLSYM_HOOK_FUNC_REPLACE(cuMemAllocAsync);
    DLSYM_HOOK_FUNC_REPLACE(cuGetProcAddress);
    DLSYM_HOOK_FUNC_REPLACE(cuGetProcAddress_v2);
    /* cuda 11.7 new memory ops */
    DLSYM_HOOK_FUNC_REPLACE(cuMemHostGetDevicePointer_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemHostGetFlags);
    DLSYM_HOOK_FUNC_REPLACE(cuMemPoolTrimTo);
    DLSYM_HOOK_FUNC_REPLACE(cuMemPoolSetAttribute);
    DLSYM_HOOK_FUNC_REPLACE(cuMemPoolGetAttribute);
    DLSYM_HOOK_FUNC_REPLACE(cuMemPoolSetAccess);
    DLSYM_HOOK_FUNC_REPLACE(cuMemPoolGetAccess);
    DLSYM_HOOK_FUNC_REPLACE(cuMemPoolCreate);
    DLSYM_HOOK_FUNC_REPLACE(cuMemPoolDestroy);
    DLSYM_HOOK_FUNC_REPLACE(cuMemAllocFromPoolAsync);
    DLSYM_HOOK_FUNC_REPLACE(cuMemPoolExportToShareableHandle);
    DLSYM_HOOK_FUNC_REPLACE(cuMemPoolImportFromShareableHandle);
    DLSYM_HOOK_FUNC_REPLACE(cuMemPoolExportPointer);
    DLSYM_HOOK_FUNC_REPLACE(cuMemPoolImportPointer);
    DLSYM_HOOK_FUNC_REPLACE(cuMemcpy2DUnaligned_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemcpy2DAsync_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemcpy3D_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemcpy3DAsync_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuMemcpy3DPeer);
    DLSYM_HOOK_FUNC_REPLACE(cuMemcpy3DPeerAsync);
    DLSYM_HOOK_FUNC_REPLACE(cuMemPrefetchAsync);
    DLSYM_HOOK_FUNC_REPLACE(cuMemRangeGetAttribute);
    DLSYM_HOOK_FUNC_REPLACE(cuMemRangeGetAttributes);
    /* cuda 11.7 external resource interoperability */
    DLSYM_HOOK_FUNC_REPLACE(cuImportExternalMemory);
    DLSYM_HOOK_FUNC_REPLACE(cuExternalMemoryGetMappedBuffer);
    DLSYM_HOOK_FUNC_REPLACE(cuExternalMemoryGetMappedMipmappedArray);
    DLSYM_HOOK_FUNC_REPLACE(cuDestroyExternalMemory);
    DLSYM_HOOK_FUNC_REPLACE(cuImportExternalSemaphore);
    DLSYM_HOOK_FUNC_REPLACE(cuSignalExternalSemaphoresAsync);
    DLSYM_HOOK_FUNC_REPLACE(cuWaitExternalSemaphoresAsync);
    DLSYM_HOOK_FUNC_REPLACE(cuDestroyExternalSemaphore);
    /* cuda Graph */
    DLSYM_HOOK_FUNC_REPLACE(cuGraphCreate);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphAddKernelNode_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphKernelNodeGetParams_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphKernelNodeSetParams_v2);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphAddMemcpyNode);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphMemcpyNodeGetParams);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphMemcpyNodeSetParams);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphAddMemsetNode);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphMemsetNodeGetParams);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphMemsetNodeSetParams);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphAddHostNode);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphHostNodeGetParams);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphHostNodeSetParams);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphAddChildGraphNode);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphChildGraphNodeGetGraph);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphAddEmptyNode);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphAddEventRecordNode);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphEventRecordNodeGetEvent);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphEventRecordNodeSetEvent);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphAddEventWaitNode);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphEventWaitNodeGetEvent);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphEventWaitNodeSetEvent);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphAddExternalSemaphoresSignalNode);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphExternalSemaphoresSignalNodeGetParams);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphExternalSemaphoresSignalNodeSetParams);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphAddExternalSemaphoresWaitNode);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphExternalSemaphoresWaitNodeGetParams);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphExternalSemaphoresWaitNodeSetParams);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphExecExternalSemaphoresSignalNodeSetParams);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphExecExternalSemaphoresWaitNodeSetParams);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphClone);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphNodeFindInClone);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphNodeGetType);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphGetNodes);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphGetRootNodes);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphGetEdges);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphNodeGetDependencies);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphNodeGetDependentNodes);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphAddDependencies);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphRemoveDependencies);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphDestroyNode);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphInstantiate);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphInstantiateWithFlags);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphUpload);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphLaunch);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphExecDestroy);
    DLSYM_HOOK_FUNC_REPLACE(cuGraphDestroy);
#ifdef HOOK_MEMINFO_ENABLE
    DLSYM_HOOK_FUNC_REPLACE(cuMemGetInfo_v2);
#endif
    return NULL;
}
